...
// 用户数据的路径
#define Smart3DCoating_APPDATAPATH						L"\\sdEngine\\Smart3DCoating"

//===================================================================================================
// 以下为用户注册表项目
#define APABI_USERINFO_KEYROOT							L"Software\\sdEngine\\Smart3DCoating\\1.0\\"

#define REGISTRY_KEY_OPTION								L"Option"	
// 是否自动连接服务器
#define REGISTRY_KEY_CONSERVER							L"ConServer"
